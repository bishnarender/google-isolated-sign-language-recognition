...
class SWA(tf.keras.callbacks.Callback):
    '''
    stochastic weight averaging: for improving the generalization of deep neural networks.
    '''
    ...
    @tf.function # decorated to optimize its execution using TensorFlow's Autograph. 
